import { FaChalkboardTeacher, FaHeadset, FaChartLine, FaDollarSign } from "react-icons/fa";
...
export default function MoreReasonsToJoin() {
  ...
  return (
    <section className="py-20">
      <SectionTitle title="More Reasons to Join Us" subtitle="Discover why thousands of students trust our platform to reach their goals."/>
