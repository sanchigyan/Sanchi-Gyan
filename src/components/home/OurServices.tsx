...
import { FaLaptopCode, FaBookOpen, FaClipboardCheck, FaUserFriends } from "react-icons/fa";
  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-950 via-gray-900 to-black py-10 md:py-20 overflow-hidden">
      ...
      <div className="z-10 relative mx-auto px-6 lg:px-12 max-w-7xl">
        {/* Section Heading */}
        <SectionTitle title="Our Services" subtitle="We deliver a complete digital learning experience that empowers students to learn smarter, not harder."/>
        ...
        <div className="gap-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`group bg-gradient-to-b ${service.gradient} backdrop-blur-lg border border-gray-700/50 rounded-3xl p-8 text-center shadow-lg hover:-translate-y-2 hover:shadow-[0_0_30px_rgb(0,237,67)] transition-all duration-300`}
            >
