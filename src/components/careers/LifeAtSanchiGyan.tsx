  ...
  return (
    <section className='py-5'>
      <div className='z-10 relative mx-auto px-6 max-w-7xl'>
        {/* Section title */}
        <SectionTitle
          title='Life at Sanchi Gyan'
          subtitle='Discover what makes working with us inspiring — our values, environment, and people who bring it all to life.'
        />
        ...
        <div className='mx-auto mt-16 max-w-4xl text-center'>
          ...
          >
            “Working here isn’t just about a job — it’s about growing, creating,
            and touching real lives. I’ve never felt more valued.”
            <span className='block mt-4 font-bold'>
              — Anjali Verma, Curriculum Lead
            </span>
          </motion.blockquote>
        </div>
      </div>
